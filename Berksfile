...
cookbook 'hadoop_spark', github: "maismail/spark-chef", branch: "FSTORE-857"
...
cookbook 'kkafka', github: "maismail/kafka-cookbook", branch: "HWORKS-638"
...
cookbook 'onlinefs', github: "maismail/onlinefs-chef", branch: "HWORKS-639"
